 ...
 * @author HP 14s
 */
public class Frame_Balok extends javax.swing.JFrame {

    /**
     * Creates new form Frame_Balok
     */
    public Frame_Balok() {
        initComponents();
        reset();
    ...
    private void initComponents() {
        ...
        tRluas.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        ...
        tRvolume.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/foto/BALOK.png"))); // NOI18N
    ...
    private void jHitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jHitungActionPerformed
        ...
        String volume = String.valueOf(blk.getVolume());
        String luas = String.valueOf(blk.getLuas());
        vVolume.setText(volume);
        vLuas.setText(luas);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_Balok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
